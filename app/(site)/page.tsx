...
export default function Home() { 
  const changeTheme = (themeName: string) => {
    ...
    const themeClasses: string[] = ['theme-green', 'theme-blue', 'theme-red', 'theme-yellow', 'theme-purple'];
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen p-2 overflow-hidden">
        <div className="
          space-y-6 
          text-center 
          w-full 
